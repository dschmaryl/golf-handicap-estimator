...
export function Header(props) {
  return (
    <Head>
      ...
      <p>
        The course rating and slope are usually listed on the scorecard from
        that course, or you can look them up at the{' '}
        ...
        handicap to be accurate, but the average rating (72) and slope (113)
        could be used.
      </p>
    </Head>
  );
